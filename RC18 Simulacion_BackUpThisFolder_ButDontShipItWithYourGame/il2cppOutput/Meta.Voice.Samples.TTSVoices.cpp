...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool SimpleDropdownList_IsInRect_mECB30324046D5F93564A780CBF66AD4D3C8BEE71 (RectTransform_t6C5DA5E41A89E0F488B001E45E58963480E543A5* ___rectTransform0, Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 ___touchPosition1, const RuntimeMethod* method) ;
...
{
	return ((  int32_t (*) (List_1_t51E4569652DAA5831739018E1DC03BF6918F807D*, int32_t, const RuntimeMethod*))List_1_IndexOf_m4803410520A110B163A6B92857AEFA8FEE015752_gshared)(__this, ___item0, method);
}
...
{
	return ((  int32_t (*) (List_1_t51E4569652DAA5831739018E1DC03BF6918F807D*, int32_t, const RuntimeMethod*))List_1_get_Item_mDE2F02C693FD9EAA8F93873E407BC46C47ACFC7A_gshared)(__this, ___index0, method);
}
...
{
	((  void (*) (List_1_t51E4569652DAA5831739018E1DC03BF6918F807D*, RuntimeObject*, const RuntimeMethod*))List_1__ctor_m9F9FACA262C60BC180B483D011636D28822CF4C5_gshared)(__this, ___collection0, method);
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SimpleDropdownList_Update_m6963604F4E70C77CCC91D357C11F31FDBB4351D4 (SimpleDropdownList_tCB18F8983DE55A61F720D7922C2B4833DB8E2DE0* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		bool L_11;
		L_11 = SimpleDropdownList_IsInRect_mECB30324046D5F93564A780CBF66AD4D3C8BEE71(L_9, L_10, NULL);
		if (L_11)
		{
			goto IL_0064;
		}
	}
	{
		...
		bool L_15;
		L_15 = SimpleDropdownList_IsInRect_mECB30324046D5F93564A780CBF66AD4D3C8BEE71(L_13, L_14, NULL);
		if (L_15)
		{
			goto IL_0064;
		}
...
IL_001a:
	{
		...
		bool L_8;
		L_8 = RectTransformUtility_RectangleContainsScreenPoint_mAD33D83F019F2E0C4BCE2D743175A042A233616A(L_5, L_6, L_7, NULL);
		return L_8;
	}
}
// System.Void Meta.Voice.Samples.TTSVoices.SimpleDropdownList::LoadDropdown(System.String[])
...
IL_0040:
	...
	}
	{
		...
		String_t* L_10;
		L_10 = String_Concat_m9B13B47FCB3DF61144D9647DDA05F527377251B0(_stringLiteralCFC95C3DC4C3B211D0C53345B2909DA31ED67B15, L_9, _stringLiteralC89FB4B5BC35CA3778FBEDAB1194C87F8C1B50B6, NULL);
...
IL_00b2:
	...
	}
	{
		...
		String_t* L_32;
		L_32 = String_Format_m9499958F4B0BB6089C75760AB647AB3CA4D55806(_stringLiteral64166266357184DBF49249DB44B305CE9EEEF412, L_28, L_31, NULL);
		NullCheck(L_25);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TTSFileToggle_Refresh_mF64535D8B75D48199CB182CF056064A1523F6623 (TTSFileToggle_tD213BE670259BDE657781AC27ABA0EE33802387C* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		String_t* L_8;
		L_8 = String_Format_m8C122B26BC5AA10E2550AECA16E57DAE10F07E30(L_4, L_7, NULL);
		NullCheck(L_3);
...
IL_005f_1:
			{
				...
				String_t* L_29;
				L_29 = String_Format_m76BF8F3A6AD789E38B708848A2688D400AAC250A(_stringLiteral9CB4F5B1B1CE2EA4649FBDAC8E0BCF83EE037A2E, L_23, L_26, L_28, NULL);
				NullCheck(L_19);
